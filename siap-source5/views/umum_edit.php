...
$ambil=  mysqli_query($koneksi, "SELECT * FROM umum WHERE no_rujukan ='$no_rujukan'") or die ("SQL Edit error");
...
if($_POST){
    ...
    //buat sql
    $sql="UPDATE umum SET nama_pasien='$nama_pasien',tgl_berobat='$tgl_berobat',penerima='$penerima',poli='$poli',
