        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Form Tambah Data Rujukan Umum</h3>
                </div>
                    ...
                    <form class="form-horizontal" action="" method="post">
                        <div class="form-group">
						 ...
						 <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="nama_pasien" class="form-control" id="inputEmail3" placeholder="Inputkan Nama Pasien yang Terlibat" required>
                            </div>
                        </div>
                         <div class="form-group">
                ...
                <div class="panel-footer">
                    <a href="?page=umum&actions=tampil" class="btn btn-danger btn-sm">
...
if($_POST){
  ...
  $penerima=$_POST['penerima'];
	...
	$dokter=$_POST['dokter'];
    //buat sql
    $sql="INSERT INTO umum VALUES ('$no_rujukan','nama_pasien','$tgl_berobat','$penerima','$poli','$dokter')";
