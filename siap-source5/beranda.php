    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Sistem Informasi Surat Rujukan Pasien di RSUD H. Abdul Manan Simatupang Kisaran</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Data Pasien Rujukan</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No Rujukan</th><th width="30%">Nama Pasien</th><th>Tgl Berobat</th><th>Penerima</th><th>Poli</th><th>Dokter</th>
                            </tr>
                        </thead>
                        <tbody>
