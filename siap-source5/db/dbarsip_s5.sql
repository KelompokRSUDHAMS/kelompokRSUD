...
--
-- Host: 127.0.0.1
-- Generation Time: 21 Jan 2019 pada 11.29
-- Versi Server: 5.6.20
-- PHP Version: 5.5.15
...
CREATE TABLE IF NOT EXISTS `bpjs` (
  ...
  `tgl_berobat` varchar(50) NOT NULL,
  `penerima` varchar(50) NOT NULL,
...
INSERT INTO `bpjs` (`no_rujukan`, `nama_pasien`, `tgl_berobat`, `penerima`, `poli`, `dokter`) VALUES
('2345666', 'Abdi', '2019-01-10', 'Madi', 'Dalam', 'dr Boyke'),
('2345666y77', 'Wahyu', '2019-01-22', 'Bambang', 'Jantung', 'dr Uchi'),
('385894', 'nama_pasien', '2019-01-10', 'Ika', 'Bedah', 'Dr Vanya'),
('467576', 'nama_pasien', '2019-01-08', 'ito', 'Saraf', 'Dr Ida'),
('5555rdgggg', 'Fadli', '2019-01-29', 'Aya', 'Dalam', 'Dr Chaca');
...
INSERT INTO `umum` (`no_rujukan`, `nama_pasien`, `tgl_berobat`, `penerima`, `poli`, `dokter`) VALUES
('2345666', 'nama_pasien', '2019-01-11', 'ddddd', 'ddfd', 'ddfdf');
